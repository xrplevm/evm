...
var (
	...
	ErrTransferOwnershipDeprecated        = errorsmod.Register(ModuleName, 26, "transferring ownership is deprecated, use AddMinter and RemoveMinter instead")
	ErrExternalTokenNotSupported          = errorsmod.Register(ModuleName, 27, "operation not supported for externally owned tokens")
	ErrMinterAlreadyExists                = errorsmod.Register(ModuleName, 28, "minter address already exists")
	ErrMinterNotFound                     = errorsmod.Register(ModuleName, 29, "minter address not found")
	ErrCannotRemoveLastMinter             = errorsmod.Register(ModuleName, 30, "cannot remove the last minter")
	ErrInvalidOwnerAddresses              = errorsmod.Register(ModuleName, 31, "invalid owner addresses")
)
