...
func (m *QueryOwnerAddressesRequest) Reset()         { *m = QueryOwnerAddressesRequest{} }
func (m *QueryOwnerAddressesRequest) String() string { return proto.CompactTextString(m) }
func (*QueryOwnerAddressesRequest) ProtoMessage()    {}
func (*QueryOwnerAddressesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1630a6677a16bf4, []int{6}
}
func (m *QueryOwnerAddressesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOwnerAddressesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOwnerAddressesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOwnerAddressesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOwnerAddressesRequest.Merge(m, src)
}
func (m *QueryOwnerAddressesRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryOwnerAddressesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOwnerAddressesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOwnerAddressesRequest proto.InternalMessageInfo

func (m *QueryOwnerAddressesRequest) GetContractAddress() string {
	if m != nil {
...
func (m *QueryOwnerAddressesResponse) Reset()         { *m = QueryOwnerAddressesResponse{} }
func (m *QueryOwnerAddressesResponse) String() string { return proto.CompactTextString(m) }
func (*QueryOwnerAddressesResponse) ProtoMessage()    {}
func (*QueryOwnerAddressesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f1630a6677a16bf4, []int{7}
}
func (m *QueryOwnerAddressesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryOwnerAddressesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryOwnerAddressesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryOwnerAddressesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryOwnerAddressesResponse.Merge(m, src)
}
func (m *QueryOwnerAddressesResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryOwnerAddressesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryOwnerAddressesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryOwnerAddressesResponse proto.InternalMessageInfo

func (m *QueryOwnerAddressesResponse) GetOwnerAddresses() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*QueryOwnerAddressesRequest)(nil), "cosmos.evm.erc20.v1.QueryOwnerAddressesRequest")
	proto.RegisterType((*QueryOwnerAddressesResponse)(nil), "cosmos.evm.erc20.v1.QueryOwnerAddressesResponse")
}
...
var fileDescriptor_f1630a6677a16bf4 = []byte{
	...
	,
}
...
func (c *queryClient) OwnerAddresses(ctx context.Context, in *QueryOwnerAddressesRequest, opts ...grpc.CallOption) (*QueryOwnerAddressesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.evm.erc20.v1.Query/OwnerAddresses", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) OwnerAddresses(ctx context.Context, req *QueryOwnerAddressesRequest) (*QueryOwnerAddressesResponse, error) {
...
func _Query_OwnerAddresses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.evm.erc20.v1.Query/OwnerAddresses",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryOwnerAddressesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOwnerAddressesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOwnerAddressesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryOwnerAddressesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryOwnerAddressesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryOwnerAddressesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.OwnerAddresses) > 0 {
		for iNdEx := len(m.OwnerAddresses) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintQuery(dAtA, i, uint64(len(m.OwnerAddresses[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *QueryOwnerAddressesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOwnerAddressesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryOwnerAddressesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOwnerAddressesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOwnerAddressesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryOwnerAddressesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryOwnerAddressesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryOwnerAddressesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
